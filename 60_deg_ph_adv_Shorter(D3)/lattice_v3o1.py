...
# Ring layout : (identical to design 1 but with smaller bends and consequently smaller FODO cells)
# - 3 arcs × (2 suppressor cells + 14 arc cells + 2 suppressor cells) = 54 arc FODO cells
...
env['l_dipole'] = 0.7  #bending length
env['ang_mb'] = 2* np.pi /96  #bending angle (96 total bending magnets)
env['l_fodo'] = 3.0  #length of each FODO cell 


#  Drift values based on 3 m per FODO cell 
env['d_arc'] = (env['l_fodo'] - 2 * env['l_dipole'] - 2 * env['l_quad']) / 4


#  Quadrupole strengths (initial guess pre matching)
env['kqf_arc'] = 0.95
env['kqd_arc'] = -0.95
...
# %%
#additional quadrupole strengths (suppressor and straight regions)
...
# definitions of the above quads
...
rf_frequency = 320.4e6  # 320 MHz               # T_rev = 1.2457e-6 s, harmonic number h  initially estimated to 400, So f_rf = 400 / 1.2457e-6 = 320.4 MHz    
...
#triplet in the straight section
...
opt_disp_TL = transfer_line_one_sixth_ring.match(
    ...
    targets=[
        ...
        xt.Target(bety=3.0, at='wig1_long_9.straight_wig1.triplet_2_0', tol=1e-6),  
        xt.Target(betx=3.0, at='wig1_long_9.straight_wig1.triplet_2_0', tol=1e-6),
        xt.Target(bety=3.0, at='marker_str_triplet_90pct.triplet_2_0::1', tol=1e-6),
        xt.Target(betx=3.0, at='marker_str_triplet_90pct.triplet_2_0::1', tol=1e-6),
    ]
)
...
opt_disp_TL = transfer_line_one_sixth_ring.match(
    ...
    targets=[
        ...
        xt.Target(alfx=0.0, at='_end_point', tol=1e-6),
        xt.Target(alfy=0.0, at='_end_point', tol=1e-6),
        xt.Target(bety=3.2, at='wig1_short_13.straight_wig1.triplet_2_0', tol=1e-6),  
        xt.Target(betx=3.2, at='wig1_short_13.straight_wig1.triplet_2_0', tol=1e-6),
        xt.Target(mux = 11.7/6 , at='_end_point', tol=1e-6),  
        xt.Target(muy = 11.8/6 , at='_end_point', tol=1e-6),  
    ]
)
...
# %%
# #export as json
RING.to_json('lattice_v3o1.json')
